class RestaurantsController < ApplicationController
  def index
    ...
    @restaurants = @q.result(:distinct => true).includes(:city, :meal, :reservations).page(params[:page]).per(10)
  ...
  def create
    ...
    @restaurant.meal_id = params[:meal_id]
    @restaurant.cost_pp = params[:cost_pp]
